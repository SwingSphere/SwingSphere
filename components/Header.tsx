...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    ...
    >
      <div className="container mx-auto grid grid-cols-[1fr_auto_1fr] items-center gap-3 sm:gap-6">
        ...
        {explorerSurface ? (
          <div className="ss-glass ss-glass--liquid flex items-center gap-1 rounded-full p-1 text-[11px] font-semibold uppercase tracking-[0.22em] text-gray-300 justify-self-center">
            <button
              type="button"
